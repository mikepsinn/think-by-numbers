...
│   ├── _data/                 # Global data (site.json, categories.js, manualParams.js, futures.js, podcastEpisodes.json)
...
│   ├── index.njk              # Homepage essay: the bill, the thermostat, the two futures, recent posts
