...
module.exports = function(eleventyConfig) {
  ...
  // Map full-size OG/infographic paths to lightweight card derivatives
  // generated by `npm run generate-card-images` (content/assets/cards/).
  // External URLs (e.g. manual.warondisease.org) are left unchanged.
  eleventyConfig.addFilter("cardImage", (url) => {
    if (!url || typeof url !== "string") return url || "";
    if (/^https?:\/\//i.test(url)) return url;
    return url
      .replace("/assets/og-images/", "/assets/cards/")
      .replace("/assets/infographics/", "/assets/cards/")
